...
def initiate():
    ...
    car_model_data = [
      ...
      {"name":"Arkana", "type":"SUV", "year": 2025, "car_make":car_make_instances[5]},
      {"name":"Alaskan", "type":"Pickup", "year": 2025, "car_make":car_make_instances[5]},
      {"name":"Oroch", "type":"Pickup", "year": 2025, "car_make":car_make_instances[5]},
      {"name":"Mustang", "type":"Coupe", "year": 2025, "car_make":car_make_instances[6]},
      {"name":"F-150", "type":"Pickup", "year": 2025, "car_make":car_make_instances[6]},
      {"name":"Ranger", "type":"Pickup", "year": 2025, "car_make":car_make_instances[6]},
    ]
